...
public class GameMaster : MonoBehaviour
{
    ...
    [SerializeField] private GameObject _invalidMapParticle;
    ...
    private void SwitchMap()
    {
        ...
        Instantiate(_invalidMapParticle, _playerCollider.transform.position, _playerCollider.transform.rotation, _playerCollider.transform);
    ...
    IEnumerator Cor_InvalidSwitchMap()
    {
        ...
        Instantiate(_invalidMapParticle, _playerCollider.transform.position, _playerCollider.transform.rotation);
